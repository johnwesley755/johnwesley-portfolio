...
const TimelineCard = ({ icon: Icon, title, date, details, index }) => {
  ...
  return (
    <motion.div
      ...
      className="relative flex items-center p-6 border hover:border-none rounded-lg shadow-lg transition-all duration-300 w-full sm:max-w-[calc(50%-20px)] lg:max-w-[calc(33.33%-20px)]"
