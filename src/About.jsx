    ...
    <section id="about" className="py-20 text-white relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <motion.div
            className="flex flex-col items-center p-6 rounded-lg border-none bg-transparent transition-all duration-300 transform scale-105 cursor-pointer border-gradient-to-r from-blue-500 to-purple-600 shadow-lg shadow-blue-500/50"
            initial={{ opacity: 0, translateY: 20 }}
            animate={isVisible ? { opacity: 1, translateY: 0 } : {}}
          ...
          {/* UI/UX Design Card */}
          <motion.div
            className="flex flex-col items-center p-6 rounded-lg border-none bg-transparent transition-all duration-300 transform scale-105 cursor-pointer border-gradient-to-r from-purple-500 to-pink-500 shadow-lg shadow-purple-500/50"
            initial={{ opacity: 0, translateY: 20 }}
            animate={isVisible ? { opacity: 1, translateY: 0 } : {}}
          ...
          <motion.div
            className="flex flex-col items-center p-6 rounded-lg border-none bg-transparent transition-all duration-300 transform scale-105 cursor-pointer border-gradient-to-r from-green-500 to-teal-500 shadow-lg shadow-green-500/50"
            initial={{ opacity: 0, translateY: 20 }}
            animate={isVisible ? { opacity: 1, translateY: 0 } : {}}
